...
public class S32Vector extends SimpleVector implements Externalizable, Comparable {
   ...
   public S32Vector(int var1) {
      this.data = new int[var1];
      this.size = var1;
   }

   public S32Vector(int var1, int var2) {
   ...
   public S32Vector(Sequence var1) {
   ...
   public int compareTo(Object var1) {
      return compareToInt(this, (S32Vector)var1);
   }
   ...
   public final Object get(int var1) {
      if(var1 > this.size) {
         ...
         return Convert.toObject((int)this.data[var1]);
      }
   }
   ...
   public final int intAt(int var1) {
      if(var1 > this.size) {
         throw new IndexOutOfBoundsException();
      } else {
   ...
   public Object setBuffer(int var1, Object var2) {
      ...
      this.data[var1] = Convert.toInt(var2);
      return Convert.toObject((int)var3);
   }
