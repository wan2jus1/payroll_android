...
public class U16Vector extends SimpleVector implements Externalizable, Comparable {
   ...
   public U16Vector(int var1) {
      this.data = new short[var1];
      this.size = var1;
   }

   public U16Vector(int var1, short var2) {
   ...
   public U16Vector(Sequence var1) {
      this.data = new short[var1.size()];
      this.addAll(var1);
   }

   public U16Vector(short[] var1) {
      this.data = var1;
   ...
   public int compareTo(Object var1) {
      return compareToInt(this, (U16Vector)var1);
   }
   ...
   public final Object get(int var1) {
      if(var1 > this.size) {
         ...
         return Convert.toObjectUnsigned((short)this.data[var1]);
      }
   }
   ...
   public Object setBuffer(int var1, Object var2) {
      ...
      this.data[var1] = Convert.toShortUnsigned(var2);
      return Convert.toObjectUnsigned((short)var3);
   }
