...
public class Reserved {
   ...
   public Reserved(String var1, int var2) {
      this.name = var1;
      this.prio = var2;
   }

   public Reserved(String var1, int var2, int var3) {
      this.name = var1;
      this.prio = var2;
      this.proc = new BinaryOp(var1, var3);
   }

   public Reserved(String var1, int var2, Procedure var3) {
      this.name = var1;
      this.prio = var2;
      this.proc = var3;
   }
