...
public class TranslationContainer {
   ...
   private Map CompTransMap = new HashMap();
   ...
   public String getCorrespondingString(String var1) {
      return this.CompTransMap.containsKey(var1)?(String)this.CompTransMap.get(var1):"Missing name";
   }
}
