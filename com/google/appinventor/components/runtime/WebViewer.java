...
public final class WebViewer extends AndroidViewComponent {
   ...
   WebViewer.WebViewInterface wvInterface;


   public WebViewer(ComponentContainer var1) {
      super(var1);
      this.webview = new WebView(var1.$context());
      this.resetWebViewClient();
      this.webview.getSettings().setJavaScriptEnabled(true);
      this.webview.setFocusable(true);
      this.wvInterface = new WebViewer.WebViewInterface(this.webview.getContext());
      this.webview.addJavascriptInterface(this.wvInterface, "AppInventor");
      this.webview.getSettings().setBuiltInZoomControls(true);
      if(SdkLevel.getLevel() >= 5) {
         EclairUtil.setupWebViewGeoLoc(this, this.webview, var1.$context());
      }
   ...
   private void resetWebViewClient() {
      if(SdkLevel.getLevel() >= 8) {
         ...
         this.webview.setWebViewClient(new WebViewer.WebViewerClient(null));
      }
   }
   ...
   @SimpleProperty
   public void FollowLinks(boolean var1) {
   ...
   public void GoToUrl(String var1) {
   ...
   @SimpleProperty
   public void HomeUrl(String var1) {
      this.homeUrl = var1;
   ...
   @SimpleProperty
   public void IgnoreSslErrors(boolean var1) {
      this.ignoreSslErrors = var1;
      this.resetWebViewClient();
   }
   ...
   public void PromptforPermission(boolean var1) {
      this.prompt = var1;
   }
   ...
   public void UsesLocation(boolean var1) {
   }
   ...
   public void WebViewString(String var1) {
      this.wvInterface.setWebViewString(var1);
   }
   ...
   public class WebViewInterface {
      ...
      public void setWebViewString(String var1) {
         this.webViewString = var1;
      }
   }
