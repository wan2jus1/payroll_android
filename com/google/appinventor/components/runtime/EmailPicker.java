...
import com.google.appinventor.components.runtime.EmailAddressAdapter;
...
public class EmailPicker extends TextBoxBase {
   ...
   public EmailPicker(ComponentContainer var1) {
      super(var1, new AutoCompleteTextView(var1.$context()));
      this.addressAdapter = new EmailAddressAdapter(var1.$context());
      ((AutoCompleteTextView)super.view).setAdapter(this.addressAdapter);
   }
